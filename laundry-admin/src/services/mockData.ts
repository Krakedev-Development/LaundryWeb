...
const pendingCustomers: CustomerProfile[] = [
  {
    id: 'p-1',
    userId: 'u-c1',
    ...
    kycStatus: 'pending',
    cedulaPhotoUrl: 'https://placehold.co/400x250/1e293b/94a3b8?text=Cédula',
    selfiePhotoUrl: 'https://placehold.co/400x400/334155/e2e8f0?text=Selfie',
  ...
  },
  {
    ...
    kycStatus: 'pending',
    cedulaPhotoUrl: 'https://placehold.co/400x250/0f172a/94a3b8?text=Cédula',
    selfiePhotoUrl: 'https://placehold.co/400x400/475569/f8fafc?text=Selfie',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
]
